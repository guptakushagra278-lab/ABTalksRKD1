...
|---|---|---|
| `/` | Landing Page | Introduces ABTalks, explains the 60-day challenge, builds trust, and provides the login entry point. |
| `/dashboard` | Student Dashboard | Shows the student's current day, streak, Build Vault, challenge progress, momentum, and achievements. |
| `/day/12` | Challenge Day | Provides the complete daily challenge experience, including the problem description, build guidance, Hindi/English toggle, and proof-of-work submission. |
/
